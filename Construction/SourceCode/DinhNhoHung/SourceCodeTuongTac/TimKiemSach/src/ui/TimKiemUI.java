...
public class TimKiemUI extends JFrame {
	...
	protected void xuLyTimKiemS() {
		SachServive sservice=new SachServive();
		ArrayList<Sach>dsSachS=sservice.timSachTheoSach(txtTim.getText());
	...
	private void addControls() {
		...
		JLabel lblNhap=new JLabel("Mời nhập:");
