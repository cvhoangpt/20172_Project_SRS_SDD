...
import library.management.ui.listbook.BookListController;
...
public class BookAddController implements Initializable {
    ...
    DataAccessHelper databaseHandler;
    @FXML
    ...
    public void initialize(URL url, ResourceBundle rb) {
        databaseHandler = DataAccessHelper.getInstance();
    }
    ...
    private void handleEditOperation() {
        ...
        if (databaseHandler.updateBook(book)) {
            AlertScene.showSimpleAlert("Success", "Book Updated");
        } else {
            AlertScene.showErrorMessage("Failed", "Cant update book");
        }
    }
}
